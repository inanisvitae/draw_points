...
SimpleGraph = function(elemid, options) {
  ...
  this.points = [{x:1.2, y:3.1, color: "yellow"}, 
                  {x:2.5, y:4.2, color: "green"}, 
                  {x:3.1,y:-1.2, color: "red"}, 
                  {x:5.6, y:100.7, color:"blue"}]
...
SimpleGraph.prototype.add_new_point = function(x, y, color) {
  var self = this;
  var newpoint = {}
  newpoint.x = x
  newpoint.y = y
...
SimpleGraph.prototype.console_logging = function() {
  var self = this
